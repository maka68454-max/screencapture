/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 889d45ca272ea18536d852bc4b299f7c)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	CREATE_RATE_LIMITER: RateLimit;
	CALLS_APP_ID: string;
	CALLS_APP_SECRET: string;
	LIVE_STREAM_ROOMS: DurableObjectNamespace<import("./src/index").LiveStreamRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiveStreamRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALLS_APP_ID" | "CALLS_APP_SECRET">> {}
}
